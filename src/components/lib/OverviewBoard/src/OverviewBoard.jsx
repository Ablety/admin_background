...
export default class OverviewBoard extends Component {
    ...
    render() {
        return (
            <Row type={'flex'} gutter={20} style={{paddingLeft:20,paddingRight:20}}>
                {navigation.map((item, index) => {
                    return (
                        <Col lg={6} key={index} style={styles.col}>
                            <div style={{background: item.color,borderRadius:5,paddingTop:20,paddingBottom:20}}>
